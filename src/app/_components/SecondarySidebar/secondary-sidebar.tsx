...
export default function SecondarySidebar(){
    ...
    return (
            <aside className = {style.aside} ref = {innerAside}>
                <div className = {style.content}>
                    <div className = {style.inner_content}>
                        <div className = {`${style.block} ${style.b1}`}>teste</div>
                        <div className = {`${style.block} ${style.b2}`}>teste</div>
                        <div className = {`${style.block} ${style.b3}`}>teste</div>
